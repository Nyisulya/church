                            ...
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-check mb-1">
                                        <input type="checkbox" id="perm_{{ $permission->id }}" name="permissions[]" value="{{ $permission->name }}"
                                            {{ in_array($permission->name, $rolePermissions) ? 'checked' : '' }} class="form-check-input">
